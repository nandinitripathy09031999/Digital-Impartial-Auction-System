                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align = 'left'>Partial Payment</TableCell>
...
const mapStateToProps = ({invoices:{filterData}}) =>({
  data:filterData
})
export default connect(mapStateToProps)(withStyles(styles)(InvoiceTable));
